Shader "Xcqy/Spine/Sprite/Pixel Lit"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			CGPROGRAM
				...
				#include "Sprite/CGIncludes/SpritePixelLighting.cginc"	
			ENDCG
		}
		Pass
		{     
		...
		Pass
		{
			...
			CGPROGRAM		
				...
				#include "Sprite/CGIncludes/SpriteShadows.cginc"
			ENDCG
		}
	}
	
	FallBack "Xcqy/Spine/Sprite/Unlit"
