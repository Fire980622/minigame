...
namespace Game.Logic
{
    public class OutlineEx : BaseMeshEffect
    {
        ...
        public void ChangeOutlineColor(Color color, int width)
        {
            this.OutlineColor = color;
            ...
            Vector2 pUVOriginMin, Vector2 pUVOriginMax)
        {
            ...
            var uv = pVertex.uv0;
            Vector2 temp1 = pUVX / pTriangleX.magnitude * posXOffset * (Vector2.Dot(pTriangleX, Vector2.right) > 0 ? 1 : -1);
            uv += new Vector4(temp1.x, temp1.y, 0, 0);
            Vector2 temp2 = pUVY / pTriangleY.magnitude * posYOffset * (Vector2.Dot(pTriangleY, Vector2.up) > 0 ? 1 : -1);
            uv += new Vector4(temp2.x, temp1.y, 0, 0);
            pVertex.uv0 = uv;
