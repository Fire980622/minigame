...
function RoleTposeLoader:BuildTpose()
    ...
    local autoReleaser = self.tpose:GetComponent(typeof(AssetAutoReleaser))
    ...
    meshNode:GetComponent(typeof(Renderer)).material.mainTexture = skin;
    ...
    local headAutoReleaser = self.headTpose:GetComponent(typeof(AssetAutoReleaser))
    ...
    headMeshNode:GetComponent(typeof(Renderer)).material.mainTexture = headSkin;
    AssetMgrProxy.Instance:IncreaseReferenceCount(self.resData.headSkinPath)
    headAutoReleaser:Add(self.resData.headSkinPath)

    local animation = self.tpose:GetComponent(typeof(Animation))
    local clip = nil
